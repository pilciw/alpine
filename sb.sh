...
curl -L -o /etc/s-box/sing-box.tar.gz  -# --retry 2 https://pilciw.pp.ua/https://github.com/SagerNet/sing-box/releases/download/v$sbcore/$sbname.tar.gz
...
curl -L -o /etc/s-box/sing-box.tar.gz  -# --retry 2 https://gh.llkk.cc/https://github.com/SagerNet/sing-box/releases/download/v$upcore/$sbname.tar.gz
if [[ -f '/etc/s-box/sing-box.tar.gz' ]]; then
tar xzf /etc/s-box/sing-box.tar.gz -C /etc/s-box
mv /etc/s-box/$sbname/sing-box /etc/s-box
rm -rf /etc/s-box/{sing-box.tar.gz,$sbname}
